...
namespace printer{
    ...
    void create_word_files_from_filenames_pair(const char* directory, std::list<std::pair<std::string, unsigned long long>> pair_list, const char* word){
        std::stringstream filename_builder;
        filename_builder << directory << "/" << word;
